...
public class ScanQueueTag extends AbstractTableModel implements IMessageEditorController {
    ...
    public IMessageEditor HRequestEditor;
    private IHttpRequestResponse currentlyDisplayedItem;
    public ScanQueueTag.URLTable Utable;
...
//        //中间修改后的面板
//        Ltable = new JTabbedPane();
//        HRequestEditor = callbacks.createMessageEditor(ScanQueueTag.this, false);
//        Ltable.addTab("Request", HRequestEditor.getComponent());
     ...
     * 获取对应任务
     * */
    public void setProperty(int id,IHttpRequestResponse newrequestResponse){
    ...
    private class URLTable extends JTable {
        ...
        public void changeSelection(int row, int col, boolean toggle, boolean extend) {
            ...
            //HRequestEditor.setMessage(dataEntry.requestResponse.getRequest(), true);
    ...
    public static class TablesData {
        ...
        private IHttpRequestResponse requestResponseEditor;
        ...
        public void requestResponseEditor(IHttpRequestResponse newrequestResponse){
            this.requestResponseEditor = newrequestResponse;
